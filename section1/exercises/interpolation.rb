...
puts "In a predictable result, the #{speedy} beat the #{slow_poke}!"
...
name = "Billy Bob"
action = "download malicious software from the darkweb"
number = 3

puts "#{name} decided to #{action} #{number} times. What a weirdo."
